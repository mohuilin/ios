...
@property(nonatomic, readwrite, strong, null_resettable) NSMutableArray<Txout*> *txOutsArray;
/** The number of items in @c txOutsArray without causing the array to be created. */
